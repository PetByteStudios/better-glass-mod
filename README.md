...
It also adds recipes to re-dye and un-dye Vanilla Glass!

\* 82 blocks as of writing this, v1.0.0-beta.5; 363 is a rough calculation of total blocks expected by v1.0.0
...
As of v1.0.0, Glass, Glass Panes, Stained Glass, Stained Glass Panes, and Tinted Glass from Vanilla have separate "Connecting" variants in `betterglass`, meanwhile, all `betterglass` native blocks connect automatically.

In a future version, all glass blocks will have separate Connecting and Non-Connection variants. This will either be done with separate blocks, crafted within the Glasscutter; or as a blockstate with a new tool.
