            ...
            dispatcher.register(Commands.literal("bgwiki")
                    .executes(context -> {
                        context.getSource().sendSuccess(() ->
                                Component.literal("    ")
                                        .append(Component.literal("Welcome to Better Glass (%s)!".formatted(BetterGlass.MOD_VERSION)).withStyle(ChatFormatting.BOLD, ChatFormatting.GOLD))
                    ...
                    .then(Commands.literal("types").executes(context -> {
                        context.getSource().sendSuccess(() ->
                                    Component.literal("")
                                            ...
                                            .append("\n    ").append(Component.literal("Coloration: ").withStyle(ChatFormatting.BOLD, ChatFormatting.BLUE))
                                            ...
                                            .append("\n    ").append(Component.literal("Behaviour: ").withStyle(ChatFormatting.BOLD, ChatFormatting.BLUE))
                                            ...
                                            .append("\n    ").append(Component.literal("Variants: ").withStyle(ChatFormatting.BOLD, ChatFormatting.BLUE))
