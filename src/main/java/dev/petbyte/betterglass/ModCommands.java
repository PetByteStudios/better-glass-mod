                                ...
                                .then(Commands.literal("recipes").executes(context -> {
                                                    context.getSource().sendSuccess(() ->
                                                                    Component.literal("")
                                                                            ...
                                                                            .append("\n\n    ").append(Component.translatable("commands.betterglass.bgwiki.recipes.check_info_on_patterns", (Component.translatable("commands.betterglass.bgwiki.recipes.strip_patterns").setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand("/bgwiki recipes strip_patterns")).withHoverEvent(new HoverEvent.ShowText(Component.literal("/bgwiki recipes strip_patterns")))).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.RED)))
