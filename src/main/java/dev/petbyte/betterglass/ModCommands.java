                                ...
                                .then(Commands.literal("recipes").executes(context -> {
                                                    context.getSource().sendSuccess(() ->
                                                                    Component.literal("")
                                                                            ...
                                                                            .append("\n\n    ").append(Component.translatable("commands.betterglass.bgwiki.recipes.check_info_on_patterns", (Component.translatable("commands.betterglass.bgwiki.recipes.patterns").setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand("/bgwiki recipes patterns")).withHoverEvent(new HoverEvent.ShowText(Component.literal("/bgwiki recipes patterns")))).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.RED)), (Component.translatable("commands.betterglass.bgwiki.recipes.strip_patterns").setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand("/bgwiki recipes strip_patterns")).withHoverEvent(new HoverEvent.ShowText(Component.literal("/bgwiki recipes strip_patterns")))).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.RED)))),
                                                            false);
                                                    return 1;
                                                })
                                                .then(Commands.literal("redye").executes(context -> {
                                                    context.getSource().sendSuccess(() ->
                                                                    Component.literal("")
                                                                            ...
                                                                            .append(Component.literal("\n  "))
                                                                            .append(Component.translatable("commands.betterglass.bgwiki.recipes.back_to_recipes").setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand("/bgwiki recipes")).withHoverEvent(new HoverEvent.ShowText(Component.literal("/bgwiki recipes")))).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.RED)),
                                                            false);
                                                    return 1;
                                                }))
                                                ...
                                                .then(Commands.literal("patterns").executes(context -> {
                                                    context.getSource().sendSuccess(() ->
                                                                    Component.literal("")
                                                                            ...
                                                                            .append(Component.translatable("commands.betterglass.generic.newline", Component.translatable("commands.betterglass.bgwiki.recipes.results_output", 4)))
                                                                            .append(Component.literal("\n  "))
                                                                            .append(Component.translatable("commands.betterglass.generic.newline_surrounded", Component.translatable("commands.betterglass.bgwiki.recipes.check_pattern_recipes", (Component.translatable("commands.betterglass.bgwiki.recipes.strip_patterns").setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand("/bgwiki recipes strip_patterns")).withHoverEvent(new HoverEvent.ShowText(Component.literal("/bgwiki recipes strip_patterns")))).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.RED)))))
